...
def recommender(job_name, num):
    ...
    if job_name is None and num is None:
        ...
        #return course_list
        return df['Title'].head(num).to_list() #return a list for plotly table creation in app
        ...
        #return a list for plotly table creation in app
        return df['Title'].head(num).to_list() 
